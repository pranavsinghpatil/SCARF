...
import { User, Settings, LogOut, HelpCircle, Menu, X, BookOpen, Workflow } from "lucide-react";
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
              <div className="flex items-center gap-3 p-3">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">user@lab.edu</p>
                </div>
              </div>
              <DropdownMenuSeparator />
              <DropdownMenuItem>
